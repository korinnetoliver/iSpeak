...
import '/components/npssurvey_widget.dart';
                        ...
                        children: [
                          Align(
                            ...
                            child: TabBar(
                              ...
                              indicatorColor: Color(0xFF527DDB),
                              tabs: [
                                Tab(
                                  text: 'Login',
                                ),
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Container(
                                          width: double.infinity,
                                          child: TextFormField(
                                            key: ValueKey('LoginPassword_67t3'),
                                            controller: _model
                  ...
                  Stack(
                    children: [
                          ...
                          builder: (context) => FFButtonWidget(
                            onPressed: () async {
                              ...
                              if (valueOrDefault<bool>(
                                  currentUserDocument?.hasSeenSurvey, false)) {
                      ...
                      if (_model.tabBarCurrentIndex == 0)
                        FFButtonWidget(
                          key: ValueKey('SignupButton_510d'),
                          onPressed: () async {
                            logFirebaseEvent('LOGIN_PAGE_SignupButton_ON_TAP');
                            ...
                            context.goNamedAuth(OnboardingPageWidget.routeName,
                                context.mounted);
                          },
                          text: 'Create Account',
                          options: FFButtonOptions(
